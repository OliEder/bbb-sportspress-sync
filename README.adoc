...
. **Einstellungen-Tab:** Club-ID eintragen (z.B. `1234`) +
  _(URL deiner Vereinsseite: `basketball-bund.net/club/id/XXXX`)_
. **Team-Discovery-Tab:** "Teams erkennen" klicken → eigene Teams mit Häkchen aktivieren → Speichern
...
Die Verwaltung erfolgt unter **SportsPress → BBB Sync** mit vier Tabs.
...
* **Tabellen-Cache leeren** – Alle Live-Tabellen- und Bracket-Caches löschen
* **Boxscore-Flags reset** – Spieler-Statistiken beim nächsten Sync neu importieren
* **Sync-Lock lösen** – Verklemmten Sync-Lock aufheben
...
│   ├── class-bbb-admin-page.php           # Admin UI (4 Tabs)
