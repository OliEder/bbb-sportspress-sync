...
Seit v1.1.4 existiert eine PHPUnit-Testinfrastruktur (`composer.json`, `phpunit.xml`,
`tests/bootstrap.php`). Statt einer echten WordPress-Installation werden globale
WP-Funktionen (`get_term_by`, `wp_insert_term`, `update_term_meta`, …) per
...
Test der gesamten Plugin-Klassen.
...
Aktueller Stand (v1.1.4, 2026-02-24): **9 Tests, 30 Assertions, alle grün.**
